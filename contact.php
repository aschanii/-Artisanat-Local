...
<body>
    ...
    <main class="container">
            ...
            <div class="contact-form">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="subject" name="subject" value="<?php echo $_POST['subject'] ?? ''; ?>" required>
                    </div>
        ...
        <div class="faq-preview">
            <h2>Quick Answers</h2>
            <p>Check our <a href="faq.php">FAQ page</a> for answers to common questions about orders, shipping, and returns.</p>
        </div>
    </main>
